...
const mockItems = [
  ...
  { id: 5, item_id: 'FUR-001', item_name: 'Kursi Kerja Ergonomis', detail: 'Mesh back support', stock: 1, unit: 'unit', description: 'Mesh back support', category: 'Furniture', min_stock: 2 },
  ...
  { id: 7, item_id: 'ITM-004', item_name: 'Keyboard Mechanical', detail: 'Blue Switch', stock: 2, unit: 'unit', description: 'Blue Switch', category: 'Electronics', min_stock: 5 }
];
...
const mockRequests = [
    ...
    },
    {
        id: 4,
        req_id: 'REQ-004',
        req_date: new Date(Date.now() - 345600000).toISOString().split('T')[0],
        formatted_req_date: new Date(Date.now() - 345600000).toISOString().split('T')[0],
        formatted_created_at: new Date(Date.now() - 345600000).toISOString().split('T')[0],
        ...
        status: 'completed',
        comment: 'Delivered',
        delivery_notes: 'Received by Admin',
        delivery_date: new Date().toISOString().split('T')[0],
        formatted_delivery_date: new Date().toISOString().split('T')[0],
    ...
    },
    {
        ...
        formatted_req_date: new Date().toISOString().split('T')[0],
        formatted_created_at: new Date().toISOString().split('T')[0],
        created_at: new Date(),
        item_id: 'FUR-001',
        item_name: 'Kursi Kerja Ergonomis',
        detail: 'Mesh back support',
        qty: 1,
        unit: 'unit',
        department: 'Finance',
        pic: 'user1',
